...
public class RecipeRepository : IRecipeRepository
{
	...
	/// <inheritdoc />
    public async Task AddCategoryToRecipeAsync(int recipeId, int categoryId)
    {
	...
	/// <inheritdoc />
    public async Task RemoveCategoryFromRecipeAsync(int recipeId, int categoryId)
    {
		var recipe = await _dbContext.Recipes
			.Where(item => item.Id == recipeId)
			.FirstOrDefaultAsync()
	...
	/// <inheritdoc />
    public async Task UpdateRecipeAsync(int recipeId, RecipeUpdateDto recipe)
    {
